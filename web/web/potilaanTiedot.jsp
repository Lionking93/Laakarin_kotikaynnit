                ...
                <div class="tab-content">
                    ...
                    <div id="potilasraportit" class="tab-pane">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                <td>15:11:2014, 14:58</td>
                                <td>Potilaalla on massiivinen krapula.</td>
                                <td><a href="luo_potilastieto.html" class="btn btn-default">Muokkaa potilasraporttia</a></td>
                            </tr>
                            <tr>
                                <td>20.11.2014, 12:05</td>
                                <td>Potilasta on purrut punkki korvan taakse. Määrätään antibioottikuuri, doksisykliiniä.</td>
                                <td><a href="luo_potilastieto.html" class="btn btn-default">Muokkaa potilasraporttia</a></td>
                            </tr>
                        </table>
                    </div>
