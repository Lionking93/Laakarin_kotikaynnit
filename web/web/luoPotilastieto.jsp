...
<t:lisaaTieto minkaTiedot="Potilaan tiedot" ekaTieto="Nimi" ekanTiedonArvo="${asiakkaanNimi}" tokaTieto="Henkilötunnus" tokanTiedonArvo="${asiakkaanHetu}"
              kolmasTieto="Osoite" kolmannenTiedonArvo="${asiakkaanOsoite}" tekstikentta="potilastieto"
    ...
    <div>
        ...
        <input class="btn btn-default" name="hoito-ohje" value="Lisää hoito-ohje" type="submit" />
    </div>
</t:lisaaTieto>
